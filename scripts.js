...
function addTheValues(param1, param2) {
    if (isNaN(param1) || isNaN(param2)) {
        ...
        addToPage("Both of the parameters are numbers, when they added equal " + (param1 + param2));
    }
}
...
// addToPage(localVariable);  // this will throw an error because localVariable is not defined
